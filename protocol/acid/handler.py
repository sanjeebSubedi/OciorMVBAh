...
This class wraps the pure ACIDState machine and handles coordination with
the Node class for inter-protocol communication (ELECTION triggering) and
...
class ACIDHandler:
    """Message handler that delegates ACIDh protocol logic to ACIDState."""
    ...
    def handle(self, msg: MVBAMessage) -> None:  # pragma: no cover
        ...
        # ------------------------------------------------------------------
        # Mirror selected flags onto the Node for ABBBA/ABBA inputs.
        ...
        # Handle inter-protocol coordination for FINISH messages
        ...
        for act in outbound:
            # For self-generated FINISH messages, handle inter-protocol coordination
